...
means finding the $m$ largest eigenvalues and their corresponding eigenvectors. The update is then projected on the set $\mathcal{T}$ defined by the template. The ALS interpretation of the
...
ha <- mdfaAlgorithmA(bfi, told, verbose = FALSE)
hb <- mdfaAlgorithmB(cfi, told, verbose = FALSE)
```
