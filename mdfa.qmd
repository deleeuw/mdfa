...
Lawley and Maxwell give a second example, using data given by
@maxwell_61.
...
First and second derivatives of the trace norm with respect to $T$ were computed in @deleeuw_E_25d. 
$$
